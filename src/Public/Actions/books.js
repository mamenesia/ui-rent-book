...
export const updateBook = (book_id, title, image, genre, desc) => {
  return {
    type: 'UPDATE_BOOK',
    // payload: Axios.patch(`http: //localhost:8080/books/${book_id}` || `https://remotemysql.com:3306/books/${book_id}`, {
...
export const rentBook = (book_id, user_id) => {
  return {
    type: 'RENT_BOOK',
    // payload: Axios.patch(`http://localhost:8080/books/rent/${book_id}` || `https://remotemysql.com:3306/books/rent/${book_id}`, {
...
export const returnBook = (book_id, user_id) => {
  return {
    type: 'RETURN_BOOK',
    // payload: Axios.patch(`http://localhost:8080/books/return/${book_id}` || `https://remotemysql.com:3306/books/return/${book_id}`, {
